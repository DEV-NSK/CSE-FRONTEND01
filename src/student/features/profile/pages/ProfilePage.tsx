...
import {
  Edit, Mail, Phone, MapPin, GraduationCap, Globe,
  Share2, FileText, ExternalLink, CheckCircle,
  Flame, Star, Trophy, Zap, Code2, BookOpen, FolderOpen,
  ChevronRight, Camera, Award, Activity, TrendingUp,
  Link2, AtSign, Film, Hash,
} from 'lucide-react'

// ── Brand SVG icons (not in this lucide-react version) ────────────────────────
...
const SOCIAL_PLATFORMS = [
  { key: 'linkedin', label: 'LinkedIn', icon: LinkedinIcon, color: '#0077b5', prefix: 'linkedin.com/in/' },
  { key: 'github', label: 'GitHub', icon: GithubIcon, color: '#6e5494', prefix: 'github.com/' },
          ...
          <motion.div key={p.id} whileHover={{ x: 2 }}
            ...
            <div className="flex items-start justify-between mb-1">
              ...
              <div className="flex gap-1.5">
                ...
                <GithubIcon className="h-3.5 w-3.5 text-slate-500 hover:text-white cursor-pointer" />
              </div>
            </div>
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex gap-2 mt-3">
              {user.linkedinUrl && <a href={user.linkedinUrl} target="_blank" rel="noopener noreferrer"
                ...
                <LinkedinIcon className="h-3.5 w-3.5 text-white" /></a>}
              {user.githubUrl && <a href={user.githubUrl} target="_blank" rel="noopener noreferrer"
                className="w-8 h-8 rounded-full bg-white/15 hover:bg-white/25 flex items-center justify-center transition-colors">
                <GithubIcon className="h-3.5 w-3.5 text-white" /></a>}
          ...
          <div className="rounded-xl p-4 bg-gradient-to-r from-[#6C5CE7]/20 to-[#2563EB]/20 border border-[#6C5CE7]/20 flex items-center gap-3">
            ...
            <div className="ml-auto flex gap-3">
              <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer"
                ...
                <LinkedinIcon className="h-3 w-3 text-slate-300" />
              </a>
